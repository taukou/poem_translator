...
- pyttsx3 - 文本轉語音
- requests - HTTP請求庫等
- azure-ai-translation-text - Azure 翻譯服務的 SDK，用於機器翻譯呼叫。
- azure-core - Azure SDK 的核心支援庫（認證與傳輸等共用功能）。
- azure-ai-textanalytics - Azure 新版文本分析 SDK（情緒分析、實體識別等）。
- azure-cognitiveservices-speech - Azure Speech SDK，用於高品質雲端語音合成與辨識。
- google-generativeai - Google Generative AI（Gemini）官方套件，用於呼叫 Gemini 大模型 API。
---
